  ...
  return (
    <div class="w-full layout-wrapper active">
      <div class="w-full flex relative">
        <aside class="block xl:block sm:hidden sidebar-wrapper w-[308px] fixed top-0 bg-white h-full z-30">
          <div class="sidebar-header relative border-r border-b   border-r-[#F7F7F7] border-b-[#F7F7F7] w-full h-[108px] flex items-center pl-[50px] z-30">
            <Link to="/">
              <img
          ...
          <div class="sidebar-body pl-[48px] pt-[14px] w-full relative z-30 h-screen overflow-style-none overflow-y-scroll pb-[200px]">
            <div class="nav-wrapper pr-[50px] mb-[36px]">
              <div class="item-wrapper mb-5">
                <h4 class="text-sm font-medium text-black border-b border-bgray-200 leading-7">
                  Menu
                </h4>
                <ul class="mt-2.5">
                  <li class="item py-[11px] text-black ">
                    <Link to="/">
        ...
        <div
          style={{ zIndex: "25" }}
          class="aside-overlay block sm:hidden w-full h-full fixed left-0 top-0 bg-white bg-opacity-30"
        ></div>
        <aside class="sm:block hidden relative w-[96px] bg-white">
          <div class="w-full sidebar-wrapper-collapse relative top-0 z-30">
            <div class="sidebar-header bg-white  sticky top-0 border-r border-b border-r-[#F7F7F7] border-b-[#F7F7F7] w-full h-[108px] flex items-center justify-center z-20">
              <Link to="/">
                <img
        ...
        <div class="body-wrapper  flex-1 overflow-x-hidden">
          <header class="md:block hidden header-wrapper w-full fixed z-30">
            <div class="w-full h-[108px] bg-white flex items-center justify-between 2xl:px-[76px] px-10 relative">
              <button
                title="Ctrl+b"
                type="button"
              ...
              <div>
                <h3 class="lg:text-3xl text-xl text-bgray-50 text-black font-bold lg:leading-[36.4px]">
                  {headerData.title}
                </h3>
                <p class="lg:text-sm text-xs text-bgray-50 text-black font-medium lg:leading-[25.2px]">
                  {headerData.desc}
                </p>
              </div>
            </div>
          ...
          <header class="md:hidden block mobile-wrapper w-full fixed z-20">
            <div class="w-full h-[80px] bg-white flex justify-between items-center">
